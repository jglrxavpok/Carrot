...
namespace Fertilizer {
    ...
    vk::DispatchLoaderDynamic& VulkanHelper::getDispatcher() {
        return *dispatch;
    }
    ...
    VulkanHelper::VulkanHelper() {
        ...
        dispatch = std::make_unique<vk::DispatchLoaderDynamic>(vkGetInstanceProcAddr);
        dispatch->init(dl);
    ...
    vk::PhysicalDevice VulkanHelper::findPhysicalDevice(vk::DispatchLoaderDynamic& dispatch) {

...
namespace Fertilizer {
    ...
    TerminalNode::TerminalNode(Fertilizer::EditorGraph& graph, TerminalNodeType type): Fertilizer::EditorNode(graph, getTitle(type), getInternalName(type)), nodeType(type) {
        init();
    }

    TerminalNode::TerminalNode(Fertilizer::EditorGraph& graph, TerminalNodeType type, const rapidjson::Value& json): Fertilizer::EditorNode(graph, getTitle(type), getInternalName(type), json), nodeType(type) {
        init();
    }

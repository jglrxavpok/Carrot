...
namespace Fertilizer {
    ...
    public:
        ...
        explicit TerminalNode(Fertilizer::EditorGraph& graph, TerminalNodeType type);
        explicit TerminalNode(Fertilizer::EditorGraph& graph, TerminalNodeType type, const rapidjson::Value& json);

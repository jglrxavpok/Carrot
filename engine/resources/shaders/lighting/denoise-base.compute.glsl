...
#ifndef PIXEL_CONVERT_TO_VEC4
#error PIXEL_CONVERT_TO_VEC4(p) is not defined. p is of type PIXEL_TYPE.
#endif
...
void main() {
    ...
    PIXEL_TYPE finalPixel = PIXEL_SWIZZLE(imageLoad(inputImage, coords));

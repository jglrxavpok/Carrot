...
namespace Carrot::Render {
    ...
    public:
        ...
        Packet& make(Carrot::Render::PassName pass, const Carrot::Render::PacketType& packetType, Carrot::Render::Viewport* viewport, bool async, std::source_location location = std::source_location::current());

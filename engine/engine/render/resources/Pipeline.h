...
namespace Carrot {
    ...
    public: // pass data to pipeline
        ...
        void setSampledImage(const Carrot::Render::Context& renderContext, const std::string& slotName, const Carrot::Render::Texture& texture, vk::ImageAspectFlags aspect = vk::ImageAspectFlagBits::eColor, vk::ImageViewType viewType = vk::ImageViewType::e2D, std::uint32_t arrayIndex = 0);
        void setSampler(const Carrot::Render::Context& renderContext, const std::string& slotName, const vk::Sampler& sampler);

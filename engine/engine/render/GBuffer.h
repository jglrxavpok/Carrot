...
namespace Carrot {
    ...
    public: // Render::Graph reimpl
        ...
        Render::Pass<Carrot::Render::PassData::Lighting>& addLightingPass(const Carrot::Render::PassData::GBuffer& opaqueData, const Carrot::Render::PassData::GBufferTransparent& transparentData, const Render::FrameResource& skyboxOutput, Render::GraphBuilder& graph, const Render::TextureSize& framebufferSize = {});

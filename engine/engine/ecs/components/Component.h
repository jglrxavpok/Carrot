...
namespace Carrot::ECS {
    ...
    public:
        ...
        // Separated from constructor: parent class may need to access child members (see ReflectionComponent)
        virtual void deserialise(const Carrot::DocumentElement& doc) {}
